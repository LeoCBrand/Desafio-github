{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyPvGIkUVH3NWd5eRi/6pn+U",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/LeoCBrand/Desafio-github/blob/main/An%C3%A1lise_Explorat%C3%B3ria.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "AfXsm269gWV0",
        "outputId": "4bbe7744-2b38-4db5-af91-40a2aac438a7"
      },
      "execution_count": 3,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "     <input type=\"file\" id=\"files-26d49979-4581-4e50-a967-12d2fdee8e85\" name=\"files[]\" multiple disabled\n",
              "        style=\"border:none\" />\n",
              "     <output id=\"result-26d49979-4581-4e50-a967-12d2fdee8e85\">\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "Hs7UheSMgWa5",
        "outputId": "2443e91b-9e93-4410-b7bc-26fb099e0815"
      },
      "execution_count": 5,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-a2ab7187-cb0c-42d4-bc26-59a50ff60050\">\n",
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-a2ab7187-cb0c-42d4-bc26-59a50ff60050')\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-a2ab7187-cb0c-42d4-bc26-59a50ff60050 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-a2ab7187-cb0c-42d4-bc26-59a50ff60050');\n",
              "          const dataTable =\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "PiwDWf2sgWfR",
        "outputId": "f4b5eec8-2a0a-4e1c-bfa4-735c44776c4a"
      },
      "execution_count": 6,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "QFf1Hh7CgWh9",
        "outputId": "c1000b89-f0a1-4eb9-9aa6-4d2ca6909175"
      },
      "execution_count": 7,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "t--PDrElgWk4",
        "outputId": "003ac986-1cc0-4694-8d3e-f2f87b13ae99"
      },
      "execution_count": 8,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "E4-pv2GKgWqN",
        "outputId": "53f3f9b2-49b2-4fee-9595-74270bb2fd0e"
      },
      "execution_count": 10,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-3a675fb1-82d1-482c-82c8-d0ac991e0dfd\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-3a675fb1-82d1-482c-82c8-d0ac991e0dfd')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-3a675fb1-82d1-482c-82c8-d0ac991e0dfd button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-3a675fb1-82d1-482c-82c8-d0ac991e0dfd');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "X4zzjb-wgWsv",
        "outputId": "4360dd39-8b21-4601-e031-6cd157d3c07c"
      },
      "execution_count": 11,
      "outputs": [
        {
    ...
    },
    {
      ...
      "source": [
        ...
        "#Criar a coluna de Lucro que será Valor Venda - Custo\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "1QzD2dgxgWx-",
        "outputId": "c81ec5a3-0d7a-4fbb-d949-764ef3096530"
      },
      "execution_count": 13,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-d2100550-23df-465e-b024-68eeaae44ecb\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-d2100550-23df-465e-b024-68eeaae44ecb')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-d2100550-23df-465e-b024-68eeaae44ecb button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-d2100550-23df-465e-b024-68eeaae44ecb');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "Ip67P_uRgW0_",
        "outputId": "c02588dd-a136-464f-a360-bb265f7e86d0"
      },
      "execution_count": 14,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "sve0w3J1gW8u",
        "outputId": "a1f3ee38-2dfb-433a-9ad6-ca7064619ae1"
      },
      "execution_count": 16,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-9f29391c-8e86-44cc-8d27-3e8f579474cb\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-9f29391c-8e86-44cc-8d27-3e8f579474cb')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-9f29391c-8e86-44cc-8d27-3e8f579474cb button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-9f29391c-8e86-44cc-8d27-3e8f579474cb');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "1EMM3ZbogXB8",
        "outputId": "ec33cf66-ab21-4ca0-b4a8-fde1f67b544c"
      },
      "execution_count": 20,
      "outputs": [
        {
          ...
          "data": {
            "text/plain": [
              ...
              "0  Adventure Works Laptop15.4W M1548 Red  Adventure Works  Adventure Works   \n",
              "\n",
              "    Classe  Cor    custo    lucro Tempo de Envio  Tempo_envio  \n",
              "0  Regular  Red  2091.48  2456.52        20 days           20  "
            ],
            "text/html": [
              "\n",
              "  <div id=\"df-48dfb9a0-cd4a-40c0-88b1-4697c9d164d9\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-48dfb9a0-cd4a-40c0-88b1-4697c9d164d9')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-48dfb9a0-cd4a-40c0-88b1-4697c9d164d9 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-48dfb9a0-cd4a-40c0-88b1-4697c9d164d9');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        "id": "urQacF9VD2gs",
        "outputId": "2cdf938f-e2cb-4f8f-8358-5a6c975633f8",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "nr_7aXmOD2i7",
        "outputId": "65e8cd1f-4bb9-47bb-b243-18440e4ccf42",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "CggjB83ND2lI",
        "outputId": "a09a54b6-64c2-44d7-d822-7046eebc9b60",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "ZPDHKGAUD2nh",
        "outputId": "527798d1-1300-4540-a1ce-19899d69e45c",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "hzqL2ffaD2ue",
        "outputId": "b9403b32-114c-4fa4-9c33-63dd82720447",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 238
        }
      ...
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-78209401-5489-4850-8a77-6318f5ddc739\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-78209401-5489-4850-8a77-6318f5ddc739')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-78209401-5489-4850-8a77-6318f5ddc739 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-78209401-5489-4850-8a77-6318f5ddc739');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        "id": "COqnjdAgD2wa",
        "outputId": "97856b3c-4b47-43b8-f4ba-9d2db75b5c21",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "AdoB24SgFWYi",
        "outputId": "f506d069-973e-4b69-868a-d948f4a68ffb",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 376
        }
      ...
      "outputs": [
        {
          ...
          "data": {
            ...
            "image/png": "\n"
          },
          "metadata": {}
        }
      ]
    },
    {
      ...
      "metadata": {
        "id": "ZUvo_NcEFWa5",
        "outputId": "1cf9a4af-34ee-4fe6-c8af-dbd044f98901",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 388
        }
    ...
    },
    {
      ...
      "metadata": {
        "id": "b096fz8oFWdm",
        "outputId": "8e906825-1672-40e6-fe4a-07cdbbc2754e",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "c9dTgOJiFWlK",
        "outputId": "708bf83a-a420-416b-be37-b36b17846fdf",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 545
        }
      ...
      "outputs": [
        {
          ...
          "data": {
            "text/plain": [
              ...
              "\n",
              "                  lucro Tempo de Envio  Tempo_envio  \n",
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-a84fbc72-731d-423a-9300-e512b5a4b887\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-a84fbc72-731d-423a-9300-e512b5a4b887')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-a84fbc72-731d-423a-9300-e512b5a4b887 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-a84fbc72-731d-423a-9300-e512b5a4b887');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        "id": "EaluEJG3FWoB",
        "outputId": "13b0bda5-b742-43d9-f3fb-af1fafcfa096",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 376
        }
    ...
    },
    {
      ...
      "metadata": {
        "id": "siWuiug1GvZd",
        "outputId": "2b801146-38bb-4cfb-991d-f29802013d06",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 376
        }
    ...
    },
    {
      ...
      "metadata": {
        "id": "e8jzlBDoGvb0",
        "outputId": "5efb4b0d-8143-4aea-c699-70618214e462",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 376
        }
    ...
    },
    {
      ...
      "metadata": {
        "id": "3mVJWZOwGveX",
        "outputId": "37cbde53-3d60-449a-b43a-e55fa4700637",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "gU4Xt1gBGvgv",
        "outputId": "14bee97a-4e1e-4c8c-e8cf-5ceb71b8a928",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 347
        }
    ...
    },
    {
      ...
      "metadata": {
        "id": "8yFo3ZIPGviq",
        "outputId": "cd0839fc-d666-4dcc-bdf9-baff9e38fba0",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 347
        }
    ...
    },
    {
      ...
      "metadata": {
        "id": "GvdWvSlNHfMh",
        "outputId": "647c1ec3-1772-414e-ad20-8c9be2f17a79",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "v6cpWZd8HfOu",
        "outputId": "d41a5b36-aefa-4364-a68f-5a800a1d75bc",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "OK3wxSoYHfRG",
        "outputId": "1f82035b-c73c-4e3f-b6a5-d04b1b29c8f9",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 212
        }
      ...
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-18f01be3-9534-4ad2-a35f-534bee04e014\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-18f01be3-9534-4ad2-a35f-534bee04e014')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-18f01be3-9534-4ad2-a35f-534bee04e014 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-18f01be3-9534-4ad2-a35f-534bee04e014');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
